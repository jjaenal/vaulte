...
// API proxy ke backend untuk mengambil daftar request sebagai owner
// Komentar (Bahasa Indonesia): Endpoint ini mem-proxy ke backend agar frontend bisa memanggil /api/marketplace/requests/owner/:address tanpa 404
...
// Untuk menghindari undefined, kita perlu `await params` terlebih dahulu.
export async function GET(
  ...
  const url = `${BACKEND}/api/marketplace/requests/owner/${encodeURIComponent(address)}`
