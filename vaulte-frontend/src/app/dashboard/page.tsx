...
import {
  ...
  useCategoriesSSE,
  DataCategory,
} from '@/hooks/useDataVaultQueries';
    ...
    return (
      <div className="py-24 text-center">
        ...
        <p className="mt-4 text-gray-500">
          You need to connect your wallet to access your data dashboard.
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="bg-white">
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4 mb-8">
          {(() => {
            ...
            const enabledCategories = userCategories
              ? (userCategories as DataCategory[]).filter(d => d.active).length
              : 0;
            ...
            const cards = [
              ...
              },
              {
                ...
                value: enabledCategories.toString(),
                subtitle: 'Live for sale',
              },
              {
                title: 'Privacy Score',
                value: `${privacyScore}/100`,
                subtitle: 'Based on settings',
              },
            ];
        ...
        <div className="bg-white shadow rounded-lg p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-1 text-xs text-gray-500">
                Latest requests, payments, and integrations
              </p>
            </div>
          </div>
        ...
        {!isLoadingCategories &&
          userCategories &&
          (userCategories as DataCategory[]).length > 0 && (
            <div className="mb-6 text-sm text-gray-600">
              You have {(userCategories as DataCategory[]).length} on-chain
              categories.
            </div>
          )}
